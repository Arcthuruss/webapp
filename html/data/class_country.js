class Country {
    ...
    constructor(alpha3, name, nameEn, capitale, continent, population, neighbour, area, currencies, languages, flag,topLevelDomain) {
        this._alpha3 = alpha3
        this._name = name
        this._nameEn = nameEn
    ...
    set nameEn(newName) {this._nameEn = newName}
